...
ggsave(plot = home_ownership_regression_plot, "figures/home_ownership_models.png", width = 9, height = 5)
```
...
ggsave(plot = home_ownership_regression_conservative_plot, "figures/home_ownership_models_conservative.png", width = 9, height = 5)
```
