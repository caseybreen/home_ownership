...
## save plots 
ggsave(plot = home_ownership_regression_plot1, here("figures/home_ownership_sib_models1.png"), width = 6, height = 4)
ggsave(plot = home_ownership_regression_plot2, here("figures/home_ownership_sib_models2.png"), width = 6, height = 4)
...
```{r}
etable(model1, model2, model4, model3, tex = T, file = here("tables/table2_regtable_homeownership_sibling_models.tex"), replace = T)
```
