...
pooled_effect_df_white <- pooled_effect_model %>%
  tidy() %>% 
  mutate(
...
## save plot
ggsave(bw_differences_homeown_longevity, filename = here("figures/fig6_homeownership_association_bw.png"), width = 6, height = 4)
```
...
etable(pooled_effect_model_white, pooled_effect_controls_model_white, pooled_effect_model_black, pooled_effect_controls_model_black, tex = T, file = here("tables/table2_regtable_homeownership_bw.tex"), replace = T)
```
