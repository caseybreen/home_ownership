...
p3 <- p3 + 
  geom_polygon(aes(x = positions$x, y = positions$y), fill = "NA", color = "black", linetype = "dotted", size= .7) + 
    theme(
...
ggsave(plot = p3, here("figures/fig4_lexis_diagram.pdf"), width = 7.5, height = 5.4)
