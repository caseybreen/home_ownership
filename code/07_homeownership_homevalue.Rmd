...
home_ownership_homevalue_plot_3models <- model1 %>% 
  ...
  labs(x = "Home Value Quartile",
       y = "Additional Years of Life") + 
  theme(legend.position = "bottom") + 
  annotate("text", x = 3.5, y = -.05, label = "Renters", fontface = "italic") + 
...
ggsave(plot = home_ownership_homevalue_plot_3models, here("figures/fig8_home_ownership_homevalue_plot_3models.pdf"), width = 6, height = 4)
